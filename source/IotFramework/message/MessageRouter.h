...
private:
    ...
    std::unique_ptr<IOT_USER_NS::UserManager> mUserManager;       // 用户管理器 / Manages user authentication and info
    std::unique_ptr<IOT_DEVICE_NS::DeviceManager> mDeviceManager; // 设备管理器 / Manages device states and registration
